...
import { VenueMapView } from '@betterat/ui/components/venue/VenueMapView';
import { NetworkSidebar } from '@betterat/ui/components/venue/NetworkSidebar';
...
import { VenueHeroCard } from '@betterat/ui/components/venue/VenueHeroCard';
import { TravelResourceChips } from '@betterat/ui/components/venue/TravelResourceChips';
...
type VenueDetectionResult = {
  ...
  message?: string;
  alternatives?: Array<{ venueId: string; name: string; distance?: number }>;
};
