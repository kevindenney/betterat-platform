...
import { useCoachWorkspace } from '@betterat/core/hooks/useCoachWorkspace';
import { useCoachEarningsSummary } from '@betterat/core/hooks/useCoachData';
...
export default function EarningsScreen() {
  ...
  const breakdownEntries = useMemo((): Array<{ label: string; value: number }> => {
    if (!summary) return [];
