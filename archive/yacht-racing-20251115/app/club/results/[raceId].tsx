...
import { VStack } from '@betterat/ui/components/ui/vstack';
import { HStack } from '@betterat/ui/components/ui/hstack';
import { Card } from '@betterat/ui/components/ui/card';
import { Button, ButtonText } from '@betterat/ui/components/ui/button';
import { Badge, BadgeText } from '@betterat/ui/components/ui/badge';
import { Input, InputField } from '@betterat/ui/components/ui/input';
import { Select, SelectTrigger, SelectInput, SelectContent, SelectItem } from '@betterat/ui/components/ui/select';
import { Checkbox, CheckboxIndicator, CheckboxIcon, CheckboxLabel } from '@betterat/ui/components/ui/checkbox';
import { CheckIcon } from '@betterat/ui/components/ui/icon';
import { supabase } from '@betterat/core/database';
import ResultsService from '@/services/ResultsService';
import { useClubWorkspace } from '@betterat/core/hooks/useClubWorkspace';
...
export default function RaceResultsEntryScreen() {
  ...
  const scoreCodes: { label: string; value: ScoreCode | 'FINISHED' }[] = [
