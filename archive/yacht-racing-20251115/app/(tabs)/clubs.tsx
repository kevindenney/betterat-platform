...
import { useClubs, useJoinClub, useClubDirectory } from '@betterat/core/hooks/useData';
...
import { ensureUuid, generateUuid } from '@betterat/core/utils/uuid';
import rhkycClubDataJson from '@/data/demo/rhkycClubData.json';
...
type DemoClubDataFile = { club?: { id: string; metadata?: ClubMetadataExtras } };
const rhkycClubData = (Array.isArray(rhkycClubDataJson)
  ? (rhkycClubDataJson[0] as DemoClubDataFile | undefined)
  : (rhkycClubDataJson as DemoClubDataFile | undefined)) || undefined;
