...
import { NavigationHeader } from '@betterat/ui/components/navigation/NavigationHeader';
import { useAuth } from '@betterat/core/providers/AuthProvider';
import { CoachWorkspaceProvider } from '@betterat/core/providers/CoachWorkspaceProvider';
import { EmojiTabIcon } from '@betterat/ui/components/icons/EmojiTabIcon';
import { useBoats } from '@betterat/core/hooks/useData';
...
function TabLayoutInner() {
  ...
  const menuItems = useMemo(() => {
    const items: { key: string; label: string; icon: string; route: string; isWarning?: boolean }[] = [];
