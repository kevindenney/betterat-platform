...
export const Colors = {
  ...
  // Tactical Zone Colors (for map legends/UI)
  tactical: {
    reliefLane: '#10B981',       // Green - matches zones.relief
    acceleration: '#EF4444',     // Red - matches zones.acceleration
    shearBoundary: '#8B5CF6',    // Purple - matches zones.shear
    leeBow: '#3B82F6',           // Blue - matches zones.leeBow
    anchoring: '#F59E0B',        // Orange - matches zones.anchoring
    eddy: '#06B6D4',             // Cyan - matches zones.eddy
  },
