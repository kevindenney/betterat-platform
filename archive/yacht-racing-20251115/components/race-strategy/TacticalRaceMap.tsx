...
import { View, Text, StyleSheet, Platform, TouchableOpacity, ScrollView, type ViewStyle } from 'react-native';
...
import type {
  ...
  TideData,
  WaveData
} from '@betterat/core/types/raceEvents';
...
import type { UnderwaterAnalysis, StrategicZone, BathymetricData } from '@betterat/core/types/bathymetry';
import { buildEnvironmentalDeckLayers } from '@betterat/ui/components/map/layers/buildEnvironmentalDeckLayers';
...
} from '@betterat/ui/components/map/overlays';
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.mapWrapper, { minHeight: 400 }]}>
        ...
        {mapLoaded && depthLayerEnabled && (
          <View style={styles.depthLegendContainer}>
...
const styles = StyleSheet.create({
  ...
  controlsContainer: {
    ...
    ...platformShadow({
      ...
      android: { elevation: 3 },
      web: '0 18px 40px rgba(15,23,42,0.18)',
    }),
  },
  controlsTitle: {
    fontSize: 16,
  ...
  depthLegendContainer: {
    ...
    ...platformShadow({
      ...
      android: { elevation: 6 },
      web: '0 25px 50px rgba(15,23,42,0.45)',
    }),
  },
  depthLegendTitle: {
    fontSize: 13,
  ...
  drawAreaButton: {
    ...
    ...platformShadow({
      ...
      android: { elevation: 4 },
      web: '0 12px 30px rgba(15,23,42,0.35)',
    }),
  },
  drawAreaButtonText: {
    fontSize: 14,
  ...
  drawingControls: {
    ...
    ...platformShadow({
      ios: { shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 4 },
      android: { elevation: 4 },
      web: '0 16px 35px rgba(15,23,42,0.25)',
    }),
    gap: 10,
  },
  drawingHint: {
