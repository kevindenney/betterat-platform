...
const Actionsheet = React.forwardRef<
  ...
  IActionsheetProps
>(function ActionsheetComponent({ className, ...props }, ref) {
  return (
    <UIActionsheet
...
>(function ActionsheetContentComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetItemComponent({ className, ...props }, ref) {
  return (
    <UIActionsheet.Item
...
>(function ActionsheetItemTextComponent(
...
>(function ActionsheetDragIndicatorComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetDragIndicatorWrapperComponent(
  { className, ...props },
  ref
) {
  return (
...
>(function ActionsheetBackdropComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetScrollViewComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetVirtualizedListComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetFlatListComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetSectionListComponent({ className, ...props }, ref) {
  return (
...
>(function ActionsheetSectionHeaderTextComponent(
  {
    className,
    isTruncated,
    bold,
...
>(function ActionsheetIconComponent(
...
Actionsheet.displayName = 'SelectActionsheet';
ActionsheetContent.displayName = 'SelectActionsheetContent';
ActionsheetItem.displayName = 'SelectActionsheetItem';
ActionsheetItemText.displayName = 'SelectActionsheetItemText';
ActionsheetDragIndicator.displayName = 'SelectActionsheetDragIndicator';
ActionsheetDragIndicatorWrapper.displayName =
  'SelectActionsheetDragIndicatorWrapper';
ActionsheetBackdrop.displayName = 'SelectActionsheetBackdrop';
ActionsheetScrollView.displayName = 'SelectActionsheetScrollView';
ActionsheetVirtualizedList.displayName =
  'SelectActionsheetVirtualizedList';
ActionsheetFlatList.displayName = 'SelectActionsheetFlatList';
ActionsheetSectionList.displayName = 'SelectActionsheetSectionList';
ActionsheetSectionHeaderText.displayName =
  'SelectActionsheetSectionHeaderText';
ActionsheetIcon.displayName = 'SelectActionsheetIcon';
