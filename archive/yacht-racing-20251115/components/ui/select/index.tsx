...
>(function SelectTriggerWrapperComponent({ ...props }, ref) {
...
type SelectStyleContext = ReturnType<typeof useStyleContext>;
function useSelectStyleContext(): SelectStyleContext {
...
const SelectInput = React.forwardRef<
  ...
  ISelectInputProps
>(function SelectInputComponent({ className, ...props }, ref) {
  const { size: parentSize, variant: parentVariant } = useSelectStyleContext();
  return (
    <UISelect.Input
...
const SelectIcon = React.forwardRef<
  ...
  ISelectIcon
>(function SelectIconComponent({ className, size, ...props }, ref) {
  const { size: parentSize } = useSelectStyleContext();
