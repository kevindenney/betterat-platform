...
const Avatar = React.forwardRef<
  ...
  IAvatarProps
>(function AvatarComponent({ className, size = 'md', ...props }, ref) {
  return (
    <UIAvatar
      ref={ref}
      {...props}
...
const AvatarBadge = React.forwardRef<
  ...
  IAvatarBadgeProps
>(function AvatarBadgeComponent({ className, size, ...props }, ref) {
...
>(function AvatarFallbackTextComponent({ className, size, ...props }, ref) {
  const { size: parentSize } = useStyleContext(SCOPE);
...
const AvatarImage = React.forwardRef<
  ...
  IAvatarImageProps
>(function AvatarImageComponent({ className, ...props }, ref) {
  return (
    <UIAvatar.Image
      ref={ref}
      {...props}
      ...
      // @ts-expect-error - web-specific style not in RN types
      style={Platform.OS === 'web' ? styles.webImage : undefined}
    />
  );
});
...
const AvatarGroup = React.forwardRef<
  ...
  IAvatarGroupProps
>(function AvatarGroupComponent({ className, ...props }, ref) {
  return (
    <UIAvatar.Group
      ref={ref}
      {...props}
