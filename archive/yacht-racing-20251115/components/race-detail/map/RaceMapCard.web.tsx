...
import { Card } from '@betterat/ui/components/race-ui/Card';
import { Typography, Spacing, BorderRadius, colors } from '@betterat/core/constants/designSystem';
import { LayerToggle } from './LayerToggle';
import TacticalRaceMap from '@betterat/ui/components/race-strategy/TacticalRaceMap';
import { createLogger } from '@betterat/core/lib/utils/logger';
import { useUnderwaterAnalysis } from '@betterat/core/hooks/useUnderwaterAnalysis';
import type { SailingVenue } from '@betterat/core/lib/types/global-venues';
...
const toRacingAreaPolygon = (
  areaPoints: { lat: number; lng: number }[],
  mapRegion: Region
): GeoJSONPolygon | null => {
...
export const RaceMapCard: React.FC<RaceMapCardProps> = ({
  ...
  const [racingArea, setRacingArea] = useState<{ lat: number; lng: number }[]>(() => {
