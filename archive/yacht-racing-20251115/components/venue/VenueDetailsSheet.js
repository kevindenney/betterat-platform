...
import { useSavedVenues } from '@betterat/core/hooks/useSavedVenues';
import { VENUE_ICONS, getCountryFlag as getFlag } from '@betterat/core/constants/sailing-icons';
import { getShadowStyle } from '@betterat/core/lib/styles/shadow';
export function VenueDetailsSheet({ venue, onClose }) {
    ...
    const getVenueTypeIcon = (type) => {
        return VENUE_ICONS[type] || VENUE_ICONS.default;
    };
    ...
    return (<Animated.View style={[
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={[styles.saveButton, isSaved && styles.saveButtonActive]} onPress={handleToggleSave} disabled={isSaving}>
          <Ionicons name={isSaved ? 'bookmark' : 'bookmark-outline'} size={22} color={isSaved ? '#007AFF' : '#666'}/>
        </TouchableOpacity>
