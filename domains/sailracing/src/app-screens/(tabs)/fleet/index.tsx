...
import { DashboardSection, QuickActionGrid, type QuickAction } from '@betterat/ui/components/dashboard/shared';
import { useAuth } from '@betterat/core/providers/AuthProvider';
import { useFleetOverview, useUserFleets } from '@betterat/core/hooks/useFleetData';
import { useFleetPosts } from '@betterat/core/hooks/useFleetSocial';
import { useFleetSuggestions } from '@betterat/core/hooks/useFleetDiscovery';
import { useFleetResources } from '@betterat/core/hooks/useFleetResources';
import { useFleetSharedContent } from '@betterat/core/hooks/useFleetSharedContent';
import type { FleetPost } from '@/services/FleetSocialService';
import {
  PostComposer,
  AnnouncementComposer,
  ResourceUploadComposer,
} from '@betterat/ui/components/fleets';
import {
  fleetService,
...
import { RealtimeConnectionIndicator } from '@betterat/ui/components/ui/RealtimeConnectionIndicator';
...
export default function FleetOverviewScreen() {
  ...
  const {
    ...
    races: sharedRaces = [],
    loading: sharedContentLoading = false,
        ...
        >
          ...
          {!suggestionsLoading && filteredSuggestions.length === 0 && (
            <Text style={styles.placeholderText}>
              We don&rsquo;t see obvious matches yet. Tap &ldquo;Find Fleets&rdquo; to browse the full directory.
            </Text>
          )}
