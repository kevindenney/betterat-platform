...
import { EnhancedRaceCard } from '@betterat/ui/components/races';
import {
  RaceDetailMapHero,
  RaceOverviewCard,
  TimingCard,
...
import { colors, Spacing } from '@betterat/core/constants/designSystem';
...
const backgroundPrimary =
  typeof colors.background === 'string'
    ? colors.background
    : ((colors as any).background?.primary ?? '#FFFFFF');
const backgroundSecondary =
  (colors as any).background?.secondary ?? colors.surface ?? '#F8FAFC';
const borderLight = (colors as any).border?.light ?? colors.border ?? '#E2E8F0';
const MOCK_RACES = [
  {
    id: '1',
    name: 'Croucher 1 & 2',
