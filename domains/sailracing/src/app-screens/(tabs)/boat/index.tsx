...
import { sailorBoatService, type SailorBoat } from '@betterat/core';
import { mockBoats as MOCK_BOATS } from '@betterat/core/constants/mockData';
        ...
        {totalBoats > 0 ? (
          ...
          <View style={styles.emptyState}>
            ...
            <View style={styles.demoSection}>
              ...
              <Text style={styles.demoSubheading}>Here&rsquo;s how boats look once added.</Text>
              <View style={styles.boatList}>
                {MOCK_BOATS.map((boat) => (
                  <View
                    key={boat.id}
