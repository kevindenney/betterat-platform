...
import type { Coordinates, SailingVenue } from '@betterat/core/lib/types/global-venues';

// Temporary stub to bypass StormGlassService error
const regionalWeatherService = {
  fetchVenueWeather: async () => ({ forecast: [], current: null }),
