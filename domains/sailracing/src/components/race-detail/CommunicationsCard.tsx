...
import { Chip } from '@betterat/ui/components/race-ui/Chip';
import { Typography, Spacing, colors, BorderRadius, Shadows } from '@betterat/core/constants/designSystem';
...
const styles = StyleSheet.create({
  ...
  contactIcon: {
    ...
    height: 24,
    borderRadius: 12,
    backgroundColor: '#EFF6FF', // primary-50 equivalent
    alignItems: 'center',
