...
function useBadgeStyleContext(): StyleContextValue {
...
const BadgeText = React.forwardRef<Text, BadgeTextProps>(function BadgeText(
  { className, size, children, ...props },
  ref
) {
  const context = useBadgeStyleContext();
