...
import { Pressable, View, ScrollView, Dimensions, Platform, type StyleProp, type ViewStyle } from 'react-native';
import {
  Motion,
  AnimatePresence,
...
const Drawer = React.forwardRef<
  ...
  IDrawerProps
>(({ className, size = 'sm', anchor = 'left', style, ...props }, ref) => {
  const pointerEventsStyle: StyleProp<ViewStyle> =
    Platform.OS === 'web'
      ? style
  ...
  const pointerProps = Platform.OS === 'web' ? null : { pointerEvents: 'box-none' as const };
...
>(({ className = '', style, ...props }, ref) => {
  ...
  const pointerProps = Platform.OS === 'web' ? null : { pointerEvents: 'auto' as const };
