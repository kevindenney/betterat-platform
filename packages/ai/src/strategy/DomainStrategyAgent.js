...
const STRATEGY_SKILL_BY_DOMAIN = {
...
export async function generateDomainPhaseSuggestion(request) {
...
export async function generateDomainStrategySuggestions(params) {
    const results = {};
...
async function invokeStrategySkill({ domainId, phase, entityTitle, context, history, }) {
...
function buildSkillPrompt({ domainId, entityTitle, phase, context, history, }) {
...
function buildFallbackSuggestion({ entityTitle, phase, history, }) {
