...
export declare function createDomain(config: DomainModule): DomainModule;
export declare function createActivityType<TMetadata = any>(config: Omit<ActivityTypeDefinition<TMetadata>, 'id'> & {
    id?: string;
}): ActivityTypeDefinition<TMetadata>;
export declare function createMetric(config: Omit<MetricDefinition, 'id'> & {
    id?: string;
}): MetricDefinition;
export declare function createAgent(config: Omit<AIAgentConfig, 'id'> & {
    id?: string;
}): AIAgentConfig;
export declare function createTool(config: AITool): AITool;
