...
export class RegionalIntelligenceService {
    constructor() {
        this.venueIntelligence = new Map();
        this.intelligenceCallbacks = [];
    }
    /**
     * Load complete regional intelligence for a venue
     */
    async loadVenueIntelligence(venue) {
        try {
            // Check cache first
     ...
     */
    async generateRegionalIntelligence(venue) {
     ...
     */
    async generateCulturalBriefing(venue) {
     ...
     */
    isIntelligenceFresh(intelligence) {
     ...
     */
    async getWeatherIntelligence(venueId) {
     ...
     */
    async getTacticalIntelligence(venueId) {
        const intelligence = this.venueIntelligence.get(venueId);
     ...
     */
    async getCulturalIntelligence(venueId) {
        const intelligence = this.venueIntelligence.get(venueId);
