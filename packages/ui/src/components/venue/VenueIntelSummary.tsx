...
import { VenueHeroCard, type VenueHeroCardProps } from './VenueHeroCard';
...
export function VenueIntelSummary({
  hero,
  stats = [],
  checklist = [],
  headerEyebrow,
          ...
          <View style={styles.statsGrid}>
            {stats.map((stat) => (
              <View key={stat.id} style={styles.statCard}>
                ...
                {stat.detail && (
                  <ThemedText style={styles.statDetail}>{stat.detail}</ThemedText>
                )}
                {stat.trend && (
...
const getStatusStyle = (status: VenueIntelChecklistStatus) => {
  switch (status) {
    case 'ready':
