...
type ResourceMeta = { label: string; icon: string; color: string };
...
export function TravelResourceChips({ layers, onToggleLayer, metaOverrides }: TravelResourceChipsProps) {
  return (
